...
exports.handleMouseMoveDocument = handleMouseMoveDocument;
exports.getActivateDelay = getActivateDelay;
...
//   this.data['key'] = value;
// }
exports.MenuAimModel = function MenuAimModel() {
  _classCallCheck(this, MenuAimModel);

  this.data = {
    mousemoveListener: 0,
    mouseLocs: []
  };
  this.mousemoveListener = 0;
  this.mouseLocs = [];
};

;

var menuAimModel = exports.menuAimModel = new MenuAimModel();
...
function getActivateDelay(config) {
  ...
  if (this._lastDelayDoc && loc.x === this._lastDelayDoc.x && loc.y === this._lastDelayDoc.y) {
    return 0;
  }
